...
public class OnlineTimeTableStandard extends Fragment {
    View myview;
    ...
    StandardOnlineTimeTableAdapter standardAdapter;
    ...
    public void generateStandradByLectures(ArrayList<StandardDetail> taskListDataList) {
        try {
            if ((taskListDataList != null && !taskListDataList.isEmpty())) {
                standardAdapter = new StandardOnlineTimeTableAdapter(taskListDataList, getActivity(),value);
