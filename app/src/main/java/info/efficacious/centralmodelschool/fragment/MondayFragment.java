...
//            Std_id= TimetableActivity_student.stdid;
    ...
    public void  StudtimeAsync (){
        try {
            Log.d("TAG","MondayTT:"+"__"+school_id+"__"+"monday"+"__"+Academic_id+"__"+Std_id+"__"+div_id);
            DataService service = RetrofitInstance.getRetrofitInstance().create(DataService.class);
            mCompositeDisposable.add(service.getTimeTableDetails("selectStudentTT",school_id,"monday",Academic_id,Std_id,"",div_id)
        ...
        return new DisposableObserver<TimeTableDetailPojo>() {
            ...
            public void onNext(@NonNull TimeTableDetailPojo timeTableDetailPojo) {
                try {
                    ...
                    Toast.makeText(getActivity(), "Something went wrong...Please try later!in Exception"  , Toast.LENGTH_SHORT).show();
                }
            ...
            public void onError(@NonNull Throwable e) {
                Toast.makeText(getActivity(), "Something went wrong...Please try later! in onError" , Toast.LENGTH_SHORT).show();
            }
    ...
    public void generateTimetableList(ArrayList<TimeTableDetail> taskListDataList) {
        try {
            if ((taskListDataList != null && !taskListDataList.isEmpty())) {
                Log.d("TAG","MondaytaskListDataList"+taskListDataList.toString());
            ...
            Toast.makeText(getActivity(), "Something went wrong...Please try later!"+ex.toString(), Toast.LENGTH_SHORT).show();
        }
    }
}